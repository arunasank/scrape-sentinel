...
if (sentinel == 2){
    console.log(`gsutil -m cp -n gs://gcp-public-data-sentinel-1/tiles/${UDM}/${latZone}/${grid}/${fullId}.SAFE/GRANULE/**/*TCI.jp2 .`);
}
else if (sentinel == 1){
    console.log(`aria2c --http-auth-challenge=true --conf-path=${root}/aria2.conf "https://api.daac.asf.alaska.edu/services/search/param?granule_list=${fullId}"`);
}
